$(document).ready(function(){
    ...
    //===============================================================
        if(cookiecheck.cookiestuff === 0){
           $.growl.notice({message: 'Faire défiler la page de gauche à droite'});
        }
        ...
        if(valid_name && valid_email){
            $.ajax({
               ...
               success: function(result) {
                   var res = result.trim();
                   if(res === 'success'){
                       $.growl.notice({message: 'Merci pour votre enquête.'});
                   }else{
                       console.log(res);
                   }
               },
            ...
            $.growl.error({message: 'Remplissez tous les champs requis.'});
        }
