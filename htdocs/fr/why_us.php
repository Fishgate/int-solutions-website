    ...
    <body>
        ...
        <div id="contentwrap_2" class="clearfix">
            ...
            <div class="left block clearfix">
                ...
                <div class="left inner_single white_BG">
                    <h2 class="generic_heading_h2 blue_light"><span class="border_bottom_grey">Pourquoi</span><br />nous</h2>
                </div>
...
<p class="grey">Notre service international de gestion de projets honore les principes d’intégrité, de transparence et d’ingénierie de la valeur. Vous avez ainsi la garantie, en travaillant avec Integrated Solutions, d’avoir toujours des solutions rentables, rapides et de qualité.</p>
                </div>
