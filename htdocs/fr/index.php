                    ...
                    <div class="left inner_double_rowspan2 no_padding_double" style="overflow: hidden;">
                        ...
                        <div class="slideshow_text grey_BG">
                            <div class="slide"><!--// SLIDER TEXT 1 \\-->
                                ...
                                <br />
                                <p class="grey"><strong>Luminance</strong> est accessible, luxe et contemporty fashion et le mode de vie magasin pour les consommateurs...<a href="project_luminance.php">view more</a></p>
                            </div>
