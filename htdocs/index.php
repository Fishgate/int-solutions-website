    ...
    <body>
        ...
        <div id="contentwrap_5" class="clearfix">
                    ...
                    <div class="left inner_double_rowspan2 no_padding_double" style="overflow: hidden;">
                        ...
                        <div class="slideshow">
                            <div class="slide" style="position: relative"><!-- /// SLIDER IMAGE 1 \\\-->
                                <img src="img/projects/Luminance/Featured/luminance_featured.jpg" alt="photo" />
                            </div>
                            <div class="slide" style="position: relative"><!-- /// SLIDER IMAGE 2 \\\-->
                        ...
                        <div class="slideshow_text grey_BG">
                            <div class="slide"><!--// SLIDER TEXT 1 \\-->
                                <h1 class="grey">Luminance</h1>
                                <br />
                                <p class="grey"><strong>Luminance</strong> is an accessible, luxury and contemporary fashion and lifestyle department store...<a href="project_luminance.php">view more</a></p>
                            </div>
                            <div class="slide"><!--// SLIDER TEXT 2 \\-->
            ...
            <div class="block left clearfix">
                ...
                <a href="careers_archive.php" class="white">
                    <div class="left inner_single blue_dark_BG link_block">
                        <div class="overlay">
                        </div>
                        <h1 class="generic_heading">Work<br /><span class="border_top_white">With Us</span></h1>
                        <img class="icon" src="img/icon_workwithus.png" alt="Who We Are" />
                        <div class="shadowed_single"></div>
                    </div>
                </a>
            </div> 
